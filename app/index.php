...
try {
    ...
    $statement = $pdo->prepare("SELECT * FROM corona_db.tbl_voluntariados");
    $statement->execute();
    ...
    $dadosXls .= "<table><thead><tr><th>id</th><th>nome</th><th>ocupacao</th><th>subcategoria</th>
    <th>telefone</th><th>celular</th><th>email</th><th>cpf</th><th>registro profisisonal</th>
    <th>ano</th><th>periodo</th></tr></thead><tbody>";
